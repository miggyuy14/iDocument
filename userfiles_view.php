...
$query = "UPDATE `user_upload` SET seen='yes' WHERE seen='no' ";
...
<div class="watermark"></div>
	...
	<div class="col-md-12 well">
		<h3 class="text-dark">Files Uploaded by Users</h3>
		...
		<table class="table table-bordered" id="myTable">
			<thead class="thead-dark">
				<tr>
					...
					<th onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(3)')" style="cursor:pointer">Uploaded By</th>
					<th>Action</th>
				</tr>
			</thead>
			<tbody class="">
				<?php	
					$row = $conn->query("SELECT * FROM `user_upload` WHERE shared_by='user'") or die(mysqli_error());
				...
				?>
					<tr class="item">
						<?php 
							...
							$id = explode('/', $fetch['id']);
							$uploader = explode('/', $fetch['uploaded_by']);
						...
						<a onClick="return checkDelete()" href="admin_userfile_delete.php?fileid=<?php echo $id[0]?>" class="btn btn-info">Delete file</a>
