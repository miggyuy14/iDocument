...
<div class="bg-info border-right" id="sidebar-wrapper">
	...
	<div class="col-md-12 well">
	   <h2>TERMS & CONDITIONS</h2>
        ...
        <form action="email_notif.php" method="post">
        <input type="checkbox" id="notif" name="notif" value="yes"> Allow Email Notifications?
         </br>
         <input type="checkbox" id="notifno" name="notifno" value="no"> Disable Email Notifications?
         </br>
